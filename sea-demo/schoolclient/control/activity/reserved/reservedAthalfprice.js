define(function(require, exports, module) {
	...
	window.jsObj.setLoadUrlTitle('特价专区');
	
	var goodsName = '',
		identifier = 'YY_SDDZ_001';
		...
		ajax.get('goods/getactivitygoodslist/' + identifier + '?goodsName=' + goodsName,'json',function(data){
			...
			if(classList.length > 0){
				for(var i = 0; i < classList.length; i++){
					htmldata += '<li>' +
								'	<a href="javascript:;" data-url="' + SAYIMO.SRVPATH + 'view/reserved/reservedDetail.html?goodsId=' + classList[i].goodsId + '&normsValueId=' + classList[i].normsValueId + '&isActivity=1&identifier=' + identifier + '">' +
