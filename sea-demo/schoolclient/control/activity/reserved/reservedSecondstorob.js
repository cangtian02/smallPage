	...
	function renderDom(_tab){
		...
		ajax.get('activity/selectbaseseckillgoodsidentifier/' + identifier + '/' + id + '/0','json',function(data){		
			...
			for(var i = 0; i < classList.length; i++){
				htmldata += '<li>' +
							'	<a href="javascript:;" data-url="' + SAYIMO.SRVPATH + 'view/reserved/reservedDetail.html?goodsId=' + classList[i].goodsId + '&normsValueId=' + classList[i].normsValueId + '&isActivity=1&identifier=' + identifier + '&seckillTimesId=' + id + '&startDate=' + startDate + '&endDate=' + endDate + '">' +
