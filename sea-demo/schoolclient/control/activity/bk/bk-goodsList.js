define(function(require, exports, module) {
	...
	var base = require('base'),
		ajax = require('ajax');
	require('./bk-goodsList.css');
	
	window.jsObj.setLoadUrlTitle('爆款商品');
	
	var identifier = 'CYBK_01',
		goodsName = '';
	...
	function getAjax(v){
		$("#classGoodList").html('');
		$("#base_load").show();
		ajax.get('goods/getmoldbabygoodslist/' + identifier + '?goodsName=' + goodsName,'json',function(data){
