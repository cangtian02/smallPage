		...
		if(data.length == 0){
			...
			for(var i = 0; i < data.length; i++){
				htmldata += '<li data-startdate="' + data[i].startDate + '" data-enddate="' + data[i].endDate + '">' +
							'<a href="javascript:;" data-url="' + SAYIMO.SRVPATH + 'view/activity/yqkj/yqkjDetail.html?goodsId=' + data[i].goodsId + '&normsValueId=' + data[i].normsValueId + '&isActivity=1&identifier=' + data[i].identifier + '">' +
							'	<div class="top">' +
							'		<div class="l">' +
