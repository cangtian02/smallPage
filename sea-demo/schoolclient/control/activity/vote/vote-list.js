define(function(require, exports, module){
	...
	window.jsObj.setLoadUrlTitle('投票列表');
	...
	ajax.get('base/listcommonvote','json',function(data){
		...
		for(var i = 0; i < data.length; i++){
			...
			htmldata += '<li>' +
						'	<a href="javascript:;" data-url="' + SAYIMO.SRVPATH + 'view/activity/vote/vote-index.html?id=' + data[i].voteSubmissionId + '&identifier=' + data[i].identifier + '">' +
